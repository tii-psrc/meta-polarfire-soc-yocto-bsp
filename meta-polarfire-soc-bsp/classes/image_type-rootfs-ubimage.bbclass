...
IMAGE_TYPES += " rootfs-ubimg"

do_image_rootfs_ubimg[depends] += "mtd-utils-native:do_populate_sysroot"

IMAGE_CMD:rootfs-ubimg () {
...
EOF
    ...
    ubinize -o ${IMGDEPLOYDIR}/${IMAGE_NAME}${IMAGE_NAME_SUFFIX}.rootfs-ubimg ${UBINIZE_ARGS} ${WORKDIR}/ubimg-${IMAGE_NAME}.cfg
...
IMAGE_TYPEDEP:rootfs-ubimg:append = " ubifs"

# So that we can use the files from excluded paths in the full images.
do_image_rootfs_ubimg[respect_exclude_path] = "0"
